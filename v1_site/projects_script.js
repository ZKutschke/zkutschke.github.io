...
function show_hide(b,d){
	...
	var button_list = ['pwc_b','nimbus_b','2671_b','bd_med_b','2.007_b','map_cart_b','map_leaks_b','pvhc_b','foundry_b','h2ouse_b','misc_b']; 
	var div_list = ['pwc_d','nimbus_d','2671_d','bd_med_d','2.007_d','map_cart_d','map_leaks_d','pvhc_d','foundry_d','h2ouse_d','misc_d']; 
